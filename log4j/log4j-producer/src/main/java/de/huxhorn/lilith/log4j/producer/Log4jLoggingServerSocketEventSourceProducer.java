...
public class Log4jLoggingServerSocketEventSourceProducer
	extends AbstractServerSocketEventSourceProducer<LoggingEvent>
{
	public Log4jLoggingServerSocketEventSourceProducer(int port)
		throws IOException
	{
		super(port);
	}
	...
	protected EventProducer<LoggingEvent> createProducer(SourceIdentifier id, AppendOperation<EventWrapper<LoggingEvent>> eventQueue, InputStream inputStream)
		throws IOException
	{
		return new Log4jLoggingStreamEventProducer(id, eventQueue, inputStream);
	}
