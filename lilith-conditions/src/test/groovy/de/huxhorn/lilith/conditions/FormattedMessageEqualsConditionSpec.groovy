...
class FormattedMessageEqualsConditionSpec extends Specification {
	@Unroll
	...
	def "equals behaves as expected."() {
		setup:
		def instance = new FormattedMessageEqualsCondition()
		def other = new FormattedMessageEqualsCondition('foo')
