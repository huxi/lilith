...
class MessagePatternContainsConditionSpec extends Specification {
	@Unroll
	...
	def "equals behaves as expected."() {
		setup:
		def instance = new MessagePatternContainsCondition()
		def other = new MessagePatternContainsCondition('foo')
