...
public final class LoggerContainsCondition
	implements LilithCondition, SearchStringCondition, Cloneable
{
	...
	public LoggerContainsCondition(String searchString)
	{
	...
	public boolean isTrue(Object value)
	{
		...
		if(value instanceof EventWrapper)
		{
			...
			if(eventObj instanceof LoggingEvent)
			{
				...
				return logger != null && logger.contains(searchString);
			}
		}
		return false;
	}
	...
	public boolean equals(Object o)
	{
		...
		final LoggerContainsCondition that = (LoggerContainsCondition) o;
