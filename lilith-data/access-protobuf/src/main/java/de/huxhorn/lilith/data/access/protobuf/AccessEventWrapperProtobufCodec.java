...
{
	public AccessEventWrapperProtobufCodec(boolean compressing)
	{
		super(new AccessEventWrapperProtobufEncoder(compressing), new AccessEventWrapperProtobufDecoder(compressing));
	}
}
