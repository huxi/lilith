	...
	implements GenericStreamWriter<LoggingEvent>, LoggingEventSchemaConstants
{
			...
			throws XMLStreamException
	{
		...
		StaxUtilities.writeAttributeIfNotNull(writer, false, prefix, NAMESPACE_URI, APPLICATION_IDENTIFIER_ATTRIBUTE, event.getApplicationIdentifier());
	...
	private void writeMdc(XMLStreamWriter writer, LoggingEvent event) throws XMLStreamException
	{
		...
		if(mdc!=null)
		{
			...
			for(Map.Entry<String,String> entry:mdc.entrySet())
			{
				...
				StaxUtilities.writeAttribute(writer, false, prefix, NAMESPACE_URI, MDC_ENTRY_KEY_ATTRIBUTE, entry.getKey(), WhiteSpaceHandling.PRESERVE_NORMALIZE_NEWLINE);
