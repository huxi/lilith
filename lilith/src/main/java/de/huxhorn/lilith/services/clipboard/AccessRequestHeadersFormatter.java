...
public class AccessRequestHeadersFormatter
		implements ClipboardFormatter
{
	private static final long serialVersionUID = -2502114753892551547L;
	...
	{
		return "Copies the request headers of the access event to the clipboard.";
	}
