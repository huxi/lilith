...
public class TwoHoursProducer
	extends AbstractGraphImageProducer
{
	public TwoHoursProducer(MainFrame mainFrame)
	{
		super(mainFrame);
	}
	...
	public RrdGraphDef getGraphDef(long nowInSeconds, SourceIdentifier sourceIdentifier, boolean showMax)
	{
		...
		graphDef.setTimeAxis(RrdGraphConstants.MINUTE,5,RrdGraphConstants.MINUTE,15,RrdGraphConstants.MINUTE,30,0,"HH:mm");
		...
		long before=nowInSeconds-2*60*60;
