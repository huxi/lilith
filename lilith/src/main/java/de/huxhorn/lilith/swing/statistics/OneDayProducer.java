	...
	extends AbstractGraphImageProducer
{
	...
	public RrdGraphDef getGraphDef(long nowInSeconds, SourceIdentifier sourceIdentifier, boolean showMax)
	{
		...
		graphDef.setTimeAxis(RrdGraphConstants.MINUTE,15,RrdGraphConstants.HOUR,1,RrdGraphConstants.HOUR,4,0,"HH:mm");
		...
		long before=nowInSeconds-24*60*60;
