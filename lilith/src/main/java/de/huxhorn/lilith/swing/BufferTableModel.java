...
public abstract class BufferTableModel<T>
		implements RowBasedTableModel<T>, /*, LoggingEventTableModelConstants*/ DisposeOperation
{
...
/*
	private final Class[] columnClasses =
			{
					COLUMN_CLASS_ID,
					COLUMN_CLASS_TIMESTAMP,
					COLUMN_CLASS_LEVEL,
					COLUMN_CLASS_LOGGER_NAME,
					COLUMN_CLASS_MESSAGE,
					COLUMN_CLASS_THROWABLE,
					COLUMN_CLASS_THREAD,
					COLUMN_CLASS_SOURCE,
			};
*/
