...
public class ThirtyDaysProducer
	extends AbstractGraphImageProducer
{
	public ThirtyDaysProducer(MainFrame mainFrame)
	{
		super(mainFrame);
	}
	...
	public RrdGraphDef getGraphDef(long nowInSeconds, SourceIdentifier sourceIdentifier, boolean showMax)
	{
		...
		graphDef.setTimeAxis(RrdGraphConstants.DAY,1,RrdGraphConstants.DAY,1,RrdGraphConstants.DAY,7,0,"yyyy-MM-dd");
		...
		long before=nowInSeconds-30*24*60*60;
