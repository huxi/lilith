...
public class NinetyDaysProducer
	extends AbstractGraphImageProducer
{
	public NinetyDaysProducer(MainFrame mainFrame)
	{
		super(mainFrame);
	}
	...
	public RrdGraphDef getGraphDef(long nowInSeconds, SourceIdentifier sourceIdentifier, boolean showMax)
	{
		...
		graphDef.setTimeAxis(RrdGraphConstants.DAY,1,RrdGraphConstants.DAY,7,RrdGraphConstants.MONTH,1,0,"yyyy-MM-dd");
		...
		long before=nowInSeconds-90*24*60*60;
